...
{
    /// <summary>
    /// Class representing a Bullish Harami pattern recognizer; a derivation of a Recognizer tailored for
    /// identifying Bullish Harami candlesticks
    /// </summary>
    class Recognizer_BullishHarami : Recognizer
    {
        /// <summary>
        /// Constructor that creates a Recognizer_BullishHarami object and initializes its respective
        ...
        /// <returns>
        /// A boolean value for the current candlestick; returns true if a Bullish Harami pattern is detected
        /// and false otherwise
        /// </returns>
