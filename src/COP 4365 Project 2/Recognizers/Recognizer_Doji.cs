...
{
    /// <summary>
    /// Class representing a Doji pattern recognizer; a derivation of a Recognizer tailored for
    /// identifying Doji candlesticks
    /// </summary>
    class Recognizer_Doji : Recognizer
    {
        /// <summary>
        /// Constructor that creates a Recognizer_Doji object and initializes its respective
        ...
        /// <returns>
        /// A boolean value for the current candlestick; returns true if a Doji pattern is detected
        /// and false otherwise
        /// </returns>
        public override bool Recognize(List<SmartCandlestick> scsList, int currIndex)
        {
            ...
            bool r = scs.BodyRange < 0.1M * scs.Range;

            // Return result of Doji check
            return r;
        }
    }
}
