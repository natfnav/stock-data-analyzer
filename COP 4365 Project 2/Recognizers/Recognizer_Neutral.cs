...
{
    /// <summary>
    /// Class representing a Neutral pattern recognizer; a derivation of a Recognizer tailored for
    /// identifying Neutral candlesticks
    /// </summary>
    class Recognizer_Neutral : Recognizer
    {
        /// <summary>
        /// Constructor that creates a Recognizer_Neutral object and initializes its respective
        ...
        /// <returns>
        /// A boolean value for the current candlestick; returns true if a Neutral pattern is detected
        /// and false otherwise
        /// </returns>
        public override bool Recognize(List<SmartCandlestick> scsList, int currIndex)
        {
            ...
            // Check for Neutral pattern
            bool r = scs.BodyRange < 0.2M * scs.Range;

            // Return result of Neutral check
            return r;
        }
    }
}
